...
import { FiCalendar, FiUser, FiTool, FiFlag, FiCheckSquare, FiFileText, FiAlertCircle, FiClipboard, FiUserCheck } from "react-icons/fi";
...
const Sidebar = () => {
  ...
  return (
    <div style={{
      ...
      <Link to="/assignments"  style={getStyle("/assignments")}  title="Assignments"><FiClipboard /></Link>
      ...
      {user && (user.role === "teacher" || user.role === "admin") && (
        <Link to="/mark-attendance" style={getStyle("/mark-attendance")} title="Mark Attendance"><FiUserCheck /></Link>
      )}
